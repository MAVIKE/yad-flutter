...
class CategoriesApi {
  ...
  Future<DomainCategory> restaurantsRidCategoriesCidGet(String rid, String cid) async {
    ...
    String path = "/restaurants/{rid}/categories/{cid}".replaceAll("{format}","json").replaceAll("{" + "rid" + "}", rid.toString()).replaceAll("{" + "cid" + "}", cid.toString());
    ...
    if(response.statusCode >= 400) {
      ...
      return 
          apiClient.deserialize(response.body, 'DomainCategory') as DomainCategory ;
    } else {
      return null;
    }
  }
  ...
  Future<List<DomainMenuItem>> restaurantsRidCategoriesCidMenuGet(String rid, String cid) async {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/restaurants/{rid}/categories/{cid}/menu".replaceAll("{format}","json").replaceAll("{" + "rid" + "}", rid.toString()).replaceAll("{" + "cid" + "}", cid.toString());
  ...
  Future<List<DomainCategory>> restaurantsRidCategoriesGet(String rid) async {
    ...
    // create path and map variables
    String path = "/restaurants/{rid}/categories/".replaceAll("{format}","json").replaceAll("{" + "rid" + "}", rid.toString());
    ...
    if(response.statusCode >= 400) {
      ...
      return 
        (apiClient.deserialize(response.body, 'List<DomainCategory>') as List).map((item) => item as DomainCategory).toList();
    } else {
      return null;
    }
  }
  ...
  Future<V1Response> restaurantsRidMenuCidDelete(String rid, String cid) async {
    ...
    // create path and map variables
    String path = "/restaurants/{rid}/menu/{cid}".replaceAll("{format}","json").replaceAll("{" + "rid" + "}", rid.toString()).replaceAll("{" + "cid" + "}", cid.toString());
