...
class OrdersApi {
  ...
  Future<V1Response> couriersCidOrdersGet(String cid) async {
    ...
    String path = "/couriers/{cid}/orders".replaceAll("{format}","json").replaceAll("{" + "cid" + "}", cid.toString());
  ...
  Future<V1Response> ordersOidDelete(String oid) async {
    ...
    // create path and map variables
    String path = "/orders/{oid}".replaceAll("{format}","json").replaceAll("{" + "oid" + "}", oid.toString());
  ...
  Future<List<DomainOrderItem>> ordersOidItemsGet(String oid) async {
    ...
    // create path and map variables
    String path = "/orders/{oid}/items/".replaceAll("{format}","json").replaceAll("{" + "oid" + "}", oid.toString());
    ...
    if(response.statusCode >= 400) {
      ...
      return 
        (apiClient.deserialize(response.body, 'List<DomainOrderItem>') as List).map((item) => item as DomainOrderItem).toList();
    } else {
      return null;
    }
  }
  ...
  Future<V1Response> ordersOidItemsIdDelete(String oid, String id) async {
    ...
    // create path and map variables
    String path = "/orders/{oid}/items/{id}".replaceAll("{format}","json").replaceAll("{" + "oid" + "}", oid.toString()).replaceAll("{" + "id" + "}", id.toString());
  ...
  Future<DomainOrderItem> ordersOidItemsIdGet(String oid, String id) async {
    ...
    if(response.statusCode >= 400) {
      ...
      return 
          apiClient.deserialize(response.body, 'DomainOrderItem') as DomainOrderItem ;
    } else {
      return null;
    }
  }
  ...
  Future<List<DomainOrder>> restaurantsRidOrdersGet(String rid) async {
    ...
    // create path and map variables
    String path = "/restaurants/{rid}/orders/".replaceAll("{format}","json").replaceAll("{" + "rid" + "}", rid.toString());
    ...
    if(response.statusCode >= 400) {
      ...
      return 
        (apiClient.deserialize(response.body, 'List<DomainOrder>') as List).map((item) => item as DomainOrder).toList();
    } else {
      return null;
    }
  }
  ...
  Future<List<DomainOrder>> usersUidOrdersGet(String uid, { String status }) async {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/users/{uid}/orders".replaceAll("{format}","json").replaceAll("{" + "uid" + "}", uid.toString());
