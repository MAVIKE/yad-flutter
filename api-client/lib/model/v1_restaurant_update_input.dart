...
class V1RestaurantUpdateInput {
  ...
  static List<V1RestaurantUpdateInput> listFromJson(List<dynamic> json) {
    return json == null
        ? new List<V1RestaurantUpdateInput>()
        : json
            .map((value) => new V1RestaurantUpdateInput.fromJson(value))
            .toList();
  }

  static Map<String, V1RestaurantUpdateInput> mapFromJson(
      Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, V1RestaurantUpdateInput>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) =>
          map[key] = new V1RestaurantUpdateInput.fromJson(value));
    }
    return map;
  }
}
