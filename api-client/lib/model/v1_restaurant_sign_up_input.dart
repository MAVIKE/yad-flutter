...
;
  ...
  static List<V1RestaurantSignUpInput> listFromJson(List<dynamic> json) {
    return json == null ? new List<V1RestaurantSignUpInput>() : json.map((value) => new V1RestaurantSignUpInput.fromJson(value)).toList();
  }

  static Map<String, V1RestaurantSignUpInput> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, V1RestaurantSignUpInput>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new V1RestaurantSignUpInput.fromJson(value));
    }
    return map;
  }
}
