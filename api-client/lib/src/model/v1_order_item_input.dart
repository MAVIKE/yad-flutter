...
abstract class V1OrderItemInput implements Built<V1OrderItemInput, V1OrderItemInputBuilder> {
    ...
    factory V1OrderItemInput([void updates(V1OrderItemInputBuilder b)]) = _$V1OrderItemInput;

    @BuiltValueSerializer(custom: true)
    static Serializer<V1OrderItemInput> get serializer => _$V1OrderItemInputSerializer();
}

class _$V1OrderItemInputSerializer implements StructuredSerializer<V1OrderItemInput> {
    @override
    ...
    @override
    V1OrderItemInput deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
