...
abstract class V1MenuItemInput
    implements Built<V1MenuItemInput, V1MenuItemInputBuilder> {
  ...
  factory V1MenuItemInput([void updates(V1MenuItemInputBuilder b)]) =
      _$V1MenuItemInput;

  @BuiltValueSerializer(custom: true)
  static Serializer<V1MenuItemInput> get serializer =>
      _$V1MenuItemInputSerializer();
}

class _$V1MenuItemInputSerializer
    implements StructuredSerializer<V1MenuItemInput> {
  @override
