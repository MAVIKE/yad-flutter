...
abstract class V1OrderUpdate
    implements Built<V1OrderUpdate, V1OrderUpdateBuilder> {
  ...
  factory V1OrderUpdate([void updates(V1OrderUpdateBuilder b)]) =
      _$V1OrderUpdate;

  @BuiltValueSerializer(custom: true)
  static Serializer<V1OrderUpdate> get serializer =>
      _$V1OrderUpdateSerializer();
}
