...
abstract class V1SignInInput implements Built<V1SignInInput, V1SignInInputBuilder> {
    ...
    factory V1SignInInput([void updates(V1SignInInputBuilder b)]) = _$V1SignInInput;

    @BuiltValueSerializer(custom: true)
    static Serializer<V1SignInInput> get serializer => _$V1SignInInputSerializer();
}
...
class _$V1SignInInputSerializer implements StructuredSerializer<V1SignInInput> {
    ...
    @override
    V1SignInInput deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
