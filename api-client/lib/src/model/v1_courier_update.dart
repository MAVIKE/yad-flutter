...
abstract class V1CourierUpdate implements Built<V1CourierUpdate, V1CourierUpdateBuilder> {
    ...
    factory V1CourierUpdate([void updates(V1CourierUpdateBuilder b)]) = _$V1CourierUpdate;

    @BuiltValueSerializer(custom: true)
    static Serializer<V1CourierUpdate> get serializer => _$V1CourierUpdateSerializer();
}

class _$V1CourierUpdateSerializer implements StructuredSerializer<V1CourierUpdate> {
    @override
    ...
    @override
    V1CourierUpdate deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
