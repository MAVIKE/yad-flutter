...
abstract class DomainMenuItem
    implements Built<DomainMenuItem, DomainMenuItemBuilder> {
  ...
  factory DomainMenuItem([void updates(DomainMenuItemBuilder b)]) =
      _$DomainMenuItem;

  @BuiltValueSerializer(custom: true)
  static Serializer<DomainMenuItem> get serializer =>
      _$DomainMenuItemSerializer();
}

class _$DomainMenuItemSerializer
    implements StructuredSerializer<DomainMenuItem> {
  @override
