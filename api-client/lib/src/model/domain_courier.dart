...
abstract class DomainCourier implements Built<DomainCourier, DomainCourierBuilder> {
    ...
    factory DomainCourier([void updates(DomainCourierBuilder b)]) = _$DomainCourier;

    @BuiltValueSerializer(custom: true)
    static Serializer<DomainCourier> get serializer => _$DomainCourierSerializer();
}
...
class _$DomainCourierSerializer implements StructuredSerializer<DomainCourier> {
    ...
    @override
    DomainCourier deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
