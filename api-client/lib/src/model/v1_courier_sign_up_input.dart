...
abstract class V1CourierSignUpInput implements Built<V1CourierSignUpInput, V1CourierSignUpInputBuilder> {
    ...
    factory V1CourierSignUpInput([void updates(V1CourierSignUpInputBuilder b)]) = _$V1CourierSignUpInput;

    @BuiltValueSerializer(custom: true)
    static Serializer<V1CourierSignUpInput> get serializer => _$V1CourierSignUpInputSerializer();
}

class _$V1CourierSignUpInputSerializer implements StructuredSerializer<V1CourierSignUpInput> {
    @override
    final Iterable<Type> types = const [V1CourierSignUpInput, _$V1CourierSignUpInput];

    @override
    final String wireName = r'V1CourierSignUpInput';

    @override
    Iterable<Object?> serialize(Serializers serializers, V1CourierSignUpInput object,
    ...
    @override
    V1CourierSignUpInput deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
