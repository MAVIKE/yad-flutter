...
abstract class DomainRestaurant
    implements Built<DomainRestaurant, DomainRestaurantBuilder> {
  ...
  factory DomainRestaurant([void updates(DomainRestaurantBuilder b)]) =
      _$DomainRestaurant;

  @BuiltValueSerializer(custom: true)
  static Serializer<DomainRestaurant> get serializer =>
      _$DomainRestaurantSerializer();
}

class _$DomainRestaurantSerializer
    implements StructuredSerializer<DomainRestaurant> {
  @override
