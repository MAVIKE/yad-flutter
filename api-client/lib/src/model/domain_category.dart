...
abstract class DomainCategory implements Built<DomainCategory, DomainCategoryBuilder> {
    ...
    factory DomainCategory([void updates(DomainCategoryBuilder b)]) = _$DomainCategory;

    @BuiltValueSerializer(custom: true)
    static Serializer<DomainCategory> get serializer => _$DomainCategorySerializer();
}

class _$DomainCategorySerializer implements StructuredSerializer<DomainCategory> {
    @override
    ...
    @override
    DomainCategory deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
