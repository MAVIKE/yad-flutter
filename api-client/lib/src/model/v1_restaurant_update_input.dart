...
abstract class V1RestaurantUpdateInput
    implements Built<V1RestaurantUpdateInput, V1RestaurantUpdateInputBuilder> {
  ...
  factory V1RestaurantUpdateInput(
          [void updates(V1RestaurantUpdateInputBuilder b)]) =
      _$V1RestaurantUpdateInput;

  @BuiltValueSerializer(custom: true)
  static Serializer<V1RestaurantUpdateInput> get serializer =>
      _$V1RestaurantUpdateInputSerializer();
}

class _$V1RestaurantUpdateInputSerializer
    implements StructuredSerializer<V1RestaurantUpdateInput> {
  @override
  ...
  Iterable<Object?> serialize(
      Serializers serializers, V1RestaurantUpdateInput object,
  ...
  @override
  V1RestaurantUpdateInput deserialize(
