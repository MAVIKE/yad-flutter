...
abstract class V1IdResponse implements Built<V1IdResponse, V1IdResponseBuilder> {
...
class _$V1IdResponseSerializer implements StructuredSerializer<V1IdResponse> {
    ...
    @override
    V1IdResponse deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
