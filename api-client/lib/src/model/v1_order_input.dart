...
abstract class V1OrderInput implements Built<V1OrderInput, V1OrderInputBuilder> {
...
class _$V1OrderInputSerializer implements StructuredSerializer<V1OrderInput> {
    ...
    @override
    V1OrderInput deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
