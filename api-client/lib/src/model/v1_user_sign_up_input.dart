...
abstract class V1UserSignUpInput implements Built<V1UserSignUpInput, V1UserSignUpInputBuilder> {
    ...
    factory V1UserSignUpInput([void updates(V1UserSignUpInputBuilder b)]) = _$V1UserSignUpInput;

    @BuiltValueSerializer(custom: true)
    static Serializer<V1UserSignUpInput> get serializer => _$V1UserSignUpInputSerializer();
}

class _$V1UserSignUpInputSerializer implements StructuredSerializer<V1UserSignUpInput> {
    @override
    ...
    @override
    V1UserSignUpInput deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
