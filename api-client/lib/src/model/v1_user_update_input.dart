...
abstract class V1UserUpdateInput
    implements Built<V1UserUpdateInput, V1UserUpdateInputBuilder> {
  ...
  factory V1UserUpdateInput([void updates(V1UserUpdateInputBuilder b)]) =
      _$V1UserUpdateInput;

  @BuiltValueSerializer(custom: true)
  static Serializer<V1UserUpdateInput> get serializer =>
      _$V1UserUpdateInputSerializer();
}

class _$V1UserUpdateInputSerializer
    implements StructuredSerializer<V1UserUpdateInput> {
  @override
