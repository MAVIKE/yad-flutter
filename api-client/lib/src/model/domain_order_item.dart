...
abstract class DomainOrderItem implements Built<DomainOrderItem, DomainOrderItemBuilder> {
    ...
    factory DomainOrderItem([void updates(DomainOrderItemBuilder b)]) = _$DomainOrderItem;

    @BuiltValueSerializer(custom: true)
    static Serializer<DomainOrderItem> get serializer => _$DomainOrderItemSerializer();
}

class _$DomainOrderItemSerializer implements StructuredSerializer<DomainOrderItem> {
    @override
    ...
    @override
    DomainOrderItem deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
