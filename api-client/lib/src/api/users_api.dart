...
class UsersApi {
  ...
  ///
  /// get current user id
  Future<Response<V1IdResponse>> usersCurrentGet({
  ...
  ///
  /// user sign up
  Future<Response<V1IdResponse>> usersSignUpPost({
  ...
  Future<Response<DomainUser>> usersUidGet({
    ...
    final _path = r'/users/{uid}'.replaceAll('{' r'uid' '}', uid.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    DomainUser _responseData;

    try {
      const _responseType = FullType(DomainUser);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as DomainUser;
