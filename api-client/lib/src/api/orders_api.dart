...
class OrdersApi {
  ...
  Future<Response<V1Response>> ordersOidDelete({ 
    ...
    final _path = r'/orders/{oid}'.replaceAll('{' r'oid' '}', oid.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltList<DomainOrderItem>>> ordersOidItemsGet({ 
    ...
    BuiltList<DomainOrderItem> _responseData;

    try {
      const _responseType = FullType(BuiltList, [FullType(DomainOrderItem)]);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
    ...
    return Response<BuiltList<DomainOrderItem>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<DomainOrderItem>> ordersOidItemsIdGet({ 
    ...
    DomainOrderItem _responseData;

    try {
      const _responseType = FullType(DomainOrderItem);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as DomainOrderItem;
    ...
    return Response<DomainOrderItem>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<BuiltList<DomainOrder>>> restaurantsRidOrdersGet({ 
    ...
    BuiltList<DomainOrder> _responseData;

    try {
      const _responseType = FullType(BuiltList, [FullType(DomainOrder)]);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
    ...
    return Response<BuiltList<DomainOrder>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
